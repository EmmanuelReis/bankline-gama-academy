...
public class UsuarioListener {
    ...
    private static Integer[] MAX_LENGTH = { Usuario.CPF_MAX_LENGTH, Usuario.LOGIN_MAX_LENGTH, Usuario.NOME_MAX_LENGTH, Usuario.SENHA_MAX_LENGTH };
    ...
    @PrePersist
    public void validaInsercaoEAtulizacao(Usuario usuario) throws InvalidDataAccessApiUsageException, DataRetrievalFailureException {
        if(usuario.getId() == null) {
            ...
            if(!parametros.isEmpty()) {
                ...
                throw new IllegalArgumentException("O" + flexao[0] + " valor" + flexao[1] + " para " + parametros.toString() + " não " + flexao[2] + " válido" + flexao[0] + "!");    
            }
