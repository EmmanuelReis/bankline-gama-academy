package com.app.gamaacademy.cabrasdoagrest.bankline.security.jwt;
...
public class JWTConstants extends OncePerRequestFilter {
	
	static final Logger LOGGER = LoggerFactory.getLogger(JWTConstants.class); 
